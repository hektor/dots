-- Based on https://github.com/mpv-player/mpv/blob/master/player/lua/osc.lua
...
local user_opts = {
    ...
    pbseekbarheight = 8,       -- playback seekbar, height of the box and handle
    pbseekbarhandlesize = 8,
    volseekbar = true,          -- volume seekbar visibility, true/nil
    volseekbarstyle = "bar",   -- volknob, bar
    volboxheight = 2,         -- volume seekbar height
    volboxwidth = 64,
    volhandlesize = 8,
